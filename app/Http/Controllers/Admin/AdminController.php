...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $data['total_coin_sold']     = Transaction::where('coin_status', 1)->where('remark', 'purchase')->sum('amount');
        $data['total_transfer_coin'] = Transaction::where('coin_status', 1)->where('remark', 'transfer')->sum('charge');
        $data['total_exchange_coin'] = Transaction::where('coin_status', 1)->where('remark', 'exchange')->sum('amount');
