    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--3">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">@lang('Total Coin Sold')</h3>
                    <p class="text-white">{{ showAmount($data['total_coin_sold']) }} {{ $general->coin_code }}</p>
                </div>
                <a href="{{route('admin.report.purchase.history')}}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div>
        <div class="col-xxl-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                <i class="las la-share-square overlay-icon text--white"></i>
                <div class="widget-two__icon b-radius--5 bg--primary">
                    <i class="las la-share-square"></i>
                </div>
                <div class="widget-two__content">
                    <h3 class="text-white">@lang('Transferred Charge')</h3>
                    <p class="text-white">{{ showAmount($data['total_transfer_coin']) }} {{ $general->coin_code }}</p>
                </div>
                <a href="{{route('admin.report.transfer.history')}}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div>
        <div class="col-xxl-4 col-sm-6">
            <div class="widget-two style--two box--shadow2 b-radius--5 bg--19">
                ...
                <div class="widget-two__content">
                    <h3 class="text-white">@lang('Total Exchanged')</h3>
                    <p class="text-white">{{ showAmount($data['total_transfer_coin']) }} {{ $general->coin_code }}</p>
                </div>
                <a href="{{route('admin.report.exchange.history')}}" class="widget-two__btn">@lang('View All')</a>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p class="lead">
              @lang('To automate the coin rate, we need to set the cron job and make sure the cron job is running properly. Set the Cron time as minimum as possible. Once per 5-15 minutes is ideal while once every minute is the best option.') </p>

              <label class="font-weight-bold">@lang('Cron Command')</label>
                <div class="input-group">
                    <input type="text" name="text" class="form-control form-control-lg" id="referralURL" value="curl -s {{route('cron')}}" readonly>
                    <button type="button" class="input-group-text copytext btn--primary copyBoard" id="copyBoard"> @lang('Copy') </button>
                </div>
        </div>
...
@push('script')
    ...
    <script>
        ...
        @if(!$general->last_cron || Carbon\Carbon::parse($general->last_cron)->diffInMinutes() > 15)
