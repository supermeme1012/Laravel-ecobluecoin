                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.transfer.history') }}">
                                <a class="nav-link" href="{{ route('admin.report.transfer.history') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Transfer History')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.report.exchange.history') }}">
                                <a class="nav-link" href="{{ route('admin.report.exchange.history') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Exchange History')</span>
                                </a>
                            </li>
