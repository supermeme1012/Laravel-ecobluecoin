                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module , that means user couldn\'t select any language to the system.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Withdrawal System')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module , that means user couldn\'t make withdraw request to the system.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="withdrawal" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if ($general->withdrawal) checked @endif>
                                </div>
                            </li>

                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Tetra Exchange')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module , that means user can not exchange Tetra to balance.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="exchange" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if ($general->exchange) checked @endif>
                                </div>
                            </li>

                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Coin Transfer')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module , that means user can not transfer coin any users.') @lang('You can configure charges of exchange from') <a href="{{ route('admin.setting.index') }}">@lang('General Settings')</a>.</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="transfer" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if ($general->transfer) checked @endif>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module , that means user can not get deposit referral bonus.') @lang('You can configure the bonus from') <a href="{{ route('admin.setting.index') }}">@lang('General Settings')</a>.</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="deposit_referral" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (@$general->deposit_referral) checked @endif>
                                </div>
                            </li>

                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Register Referral')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module , that means user can not get register referral bonus.') @lang('You can configure the bonus from') <a href="{{ route('admin.setting.index') }}">@lang('General Settings')</a>.</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="register_referral" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if (@$general->register_referral) checked @endif>
                                </div>
                            </li>
