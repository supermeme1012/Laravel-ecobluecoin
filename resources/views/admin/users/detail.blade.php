            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-6 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--warning">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->coin_currency }}{{ showAmount($user->coin, 8) }}</h3>
                            <p class="text-white">@lang('Coin')</p>
                        </div>
                        <a class="widget-two__btn" href="{{ route('admin.report.purchase.history') }}?search={{ $user->username }}">@lang('View All')</a>
                    </div>
                </div>
